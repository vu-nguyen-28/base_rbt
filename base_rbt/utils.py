...
# %% auto 0
__all__ = ['PACKAGE_NAME', 'get_package_name', 'test_grad_on', 'test_grad_off', 'seed_everything',
           'adjust_config_with_derived_values', 'load_config', 'get_ssl_dls', 'get_resnet_encoder',
...
def get_package_name():
    ...
    config.read('../settings.ini')  # Adjust the path if necessary
