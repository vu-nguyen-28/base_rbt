  ...
  'syms': { 'base_rbt.all': {},
            ...
            'base_rbt.base_supervised': { 'base_rbt.base_supervised.LM': ('base_supervised.html#lm', 'base_rbt/base_supervised.py'),
                                          ...
                                          'base_rbt.base_supervised.LinearBt.show': ( 'base_supervised.html#linearbt.show',
                                                                                      'base_rbt/base_supervised.py'),
                                          'base_rbt.base_supervised.SaveLearnerAfterFit': ( 'base_supervised.html#savelearnerafterfit',
                                                                                            'base_rbt/base_supervised.py'),
                                          'base_rbt.base_supervised.SaveLearnerAfterFit.__init__': ( 'base_supervised.html#savelearnerafterfit.__init__',
                                                                                                     'base_rbt/base_supervised.py'),
                                          'base_rbt.base_supervised.SaveLearnerAfterFit.after_fit': ( 'base_supervised.html#savelearnerafterfit.after_fit',
                                                                                                      'base_rbt/base_supervised.py'),
                                          ...
                                          'base_rbt.base_supervised.get_supervised_dls': ( 'base_supervised.html#get_supervised_dls',
                                                                                           'base_rbt/base_supervised.py'),
                                          'base_rbt.base_supervised.get_supervised_experiment_state': ( 'base_supervised.html#get_supervised_experiment_state',
                                                                                                        'base_rbt/base_supervised.py'),
